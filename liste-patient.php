...
$ge = $database->prepare("SELECT * FROM patient ");
...
<div class="main-content">
     ...
     <tr>
      ...
      <th width="250px">Date naissance</th>
      <th width="260px">Numéro</th>
      <th width="260px"></th>
     </tr>
      </table>';
      ...
      foreach($ge AS $data){
       ...
       <tr>
          ...
          <td width='260px'>".$data["daten"]."</td>
          <td width='260px'>".$data["numerotel"]."</td>
      
          <td width='260px'> <button  name='r' value='".$data["idpatient"]."'> supp </button></td>
        </tr>
        </table></form>";};
        echo'
...
$database =new PDO("mysql:host=localhost; dbname=dbcabinet",$username,$password);
 ...
 $ad = $database->prepare("DELETE FROM patient WHERE idpatient=:id");
 $ad->bindParam(":id",$data["idpatient"]); 
