...
if(isset($_POST["submit"])){
      ...
      $ad->execute();
       ...
       $gtline = $database->prepare("INSERT INTO ordonance (dateord,idpatient) VALUES(:dateord,:idpatient)");
      
       $gtline->bindParam(":dateord",$date);
       ...
       $gtline->execute();
       echo"<script> alert( ' ordonance ajoutée dans cette date ' ) </script>";
